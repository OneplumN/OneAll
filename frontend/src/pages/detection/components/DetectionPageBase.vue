  ...
  >
    ...
    <div class="detection-layout">
      <div class="detection-content">
        ...
        <el-card shadow="never" class="detection-card config-wrapper">
          ...
          <div class="repository-filters config-toolbar">
          ...
          <div v-if="$slots.config" class="config-body">
            <slot name="config" />
          </div>

          <footer v-if="$slots['config-footer']" class="config-footer">
