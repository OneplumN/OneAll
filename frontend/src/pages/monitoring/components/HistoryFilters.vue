<template>
  <el-card shadow="never" class="filters-card">
    <el-form :model="localFilters" label-width="100px" inline class="filters-form">
      ...
      <el-form-item label="状态">
        <el-select v-model="localFilters.status" placeholder="全部状态" clearable>
          <el-option
      ...
      <el-form-item label="协议">
        <el-select v-model="localFilters.protocol" placeholder="全部协议" clearable>
          <el-option
      ...
      <el-form-item>
        <el-space>
          <el-button type="primary" @click="emitFilters">查询</el-button>
...
import type { ProbeScheduleExecutionFilters } from '@/services/probeScheduleExecutionApi';
