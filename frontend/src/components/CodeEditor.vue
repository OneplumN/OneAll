<template>
  <div class="code-editor">
    ...
    <div class="code-editor__pane" :style="paneStyle">
      <pre class="code-editor__highlight" aria-hidden="true" ref="inlinePre"><code v-html="highlighted"></code></pre>
      <textarea
    ...
    >
      <div class="code-editor__pane code-editor__pane--fullscreen">
        <pre class="code-editor__highlight" aria-hidden="true" ref="dialogPre"><code v-html="highlighted"></code></pre>
        <textarea
          class="code-editor__textarea"
          v-model="innerValue"
          spellcheck="false"
