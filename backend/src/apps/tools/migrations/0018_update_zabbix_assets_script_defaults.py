...
SCRIPT_BODY = """\"\"\"资产信息 · Zabbix 主机同步脚本（内置默认 API 参数）。

若 CONFIG / 环境变量未提供 zabbix_url、zabbix_token，则使用脚本内置默认值：
  URL: http://101.43.54.131/api_jsonrpc.php
  TOKEN: 90c8d1eef412c9ac00b233675f5ed6b86530659db5ae025bb713b75da63a387a

脚本会调用 host.get 获取主机列表，并写入 ASSET_SYNC_ZABBIX_FILE 指定的 JSON 文件。
\"\"\"
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("tools", "0017_update_zabbix_assets_script"),
    ]
