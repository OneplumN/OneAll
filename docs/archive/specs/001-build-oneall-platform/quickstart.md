...
> 历史说明：本 quickstart 已按当前仓库目录修正启动路径，但仍服务于 `001-build-oneall-platform` 这一历史方案范围。若与当前 README 或代码冲突，请以当前代码为准。

## 1. 前置条件
- Node.js 20.x（含 pnpm 10+）
- Python 3.11 与 `venv`
...
| 日期 | 负责人 | 覆盖范围 | 结果 |
|------|--------|----------|------|
| 2025-11-06 | demo-admin | Probe / Detection / ITSM / Asset / Tool | ✅ 全部完成，演示数据由 `seed_demo_data` 生成 |
